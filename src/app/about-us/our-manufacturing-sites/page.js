...
export default async function OurManufacturingSitesPage() {
  ...
  const bannerData = manufacturingData.banner || {
    title: {
  ...
  // Default intro data
  const introData = manufacturingData.introSection || {
  ...
  // Default country sections (fallback data)
  const defaultIndiaData = {
    heading: "INDIA",
    sites: [
      {
        title: "Aurangabad",
  ...
  const indiaData = manufacturingData.countryAddressSection || defaultIndiaData;
  const northAmericaData = manufacturingData.northAmericaSection || defaultNorthAmericaData;
  const latamData = manufacturingData.latamSection || defaultLatamData;

  return (
    <div style={{ position: 'relative' }}>
      <InnerBanner data={bannerData} />
      <ManufacturingIntro data={introData} />
      <ManufacturingCountrySection data={indiaData} />
      <div className="manufacturing-regions-wrapper">
        ...
        <ManufacturingCountrySection data={northAmericaData} />
        <ManufacturingCountrySection data={latamData} />
      </div>
    </div>
  );
}
