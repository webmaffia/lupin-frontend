...
export default async function LeaderDetailsPage({ params }) {
  ...
  // Leader data - in production, fetch from Strapi based on slug
  // TODO: Fetch from Strapi using slug
  // const strapiData = await fetchAPI(`leaders?filters[slug][$eq]=${slug}&populate=deep`);
  // const leaderData = mapLeaderData(strapiData);
  
  const leaderData = {
    name: "Vinita Gupta",
    title: "Chief Executive Officer",
    image: {
      url: "/assets/images/2dd12f8c18d7c9fb3591b404f57d6fbb00abdcb4.png",
      alt: "Vinita Gupta"
    },
        ...
        <section className="leader-education">
          <div className="leader-education__container">
            <div className="leader-education__content">
              ...
              <div className="leader-education__text">
                <p>{leaderData.committeeMembership}</p>
              </div>
            </div>
          </div>
        </section>
      ...
      <section className="leader-cta">
        <div className="leader-cta__container">
          <div className="leader-cta__buttons">
            <button className="leader-cta__button leader-cta__button--appointment" aria-label="Appointment Resolution">
              ...
              <div className="leader-cta__button-text-wrapper">
                <span className="leader-cta__button-text">Appointment Resolution</span>
              </div>
            </button>
            <button className="leader-cta__button leader-cta__button--directorships" aria-label="Other Directorships">
              <span className="leader-cta__button-text">Other Directorships</span>
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M2.9834 1.86914H19.6985V18.7856" stroke="white" stroke-width="3.7365" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M1.86816 19.6996L19.6986 1.86914" stroke="white" stroke-width="3.7365" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
            </button>
          </div>
        </div>
