...
import '@/scss/components/OurStorySection.scss';

export default function OurStorySection() {
  return (
    <section className="our-story-section" data-node-id="2888:550">
      <div className="our-story-section__container">
        <div className="our-story-section__header" data-node-id="2888:551">
          <h2 className="our-story-section__title" data-node-id="2888:552">Our Milestones</h2>
          <p className="our-story-section__subtitle" data-node-id="2888:553">Journey of Care Shaped by Courage and Conviction</p>
        </div>
